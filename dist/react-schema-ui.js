(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-schema-ui"] = factory(require("React"));
	else
		root["react-schema-ui"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	   SchemaObjectView: __webpack_require__(5),
	   SchemaPropertyView: __webpack_require__(9),
	   SchemaPropertyValueViewer: __webpack_require__(165)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* when placeholder values are used, make them a bit muted */\n.rsui-property-value-placeholder\n{\n   opacity: 0.5;\n}\n\n/* don't show the editor until we're ready */\n.rsui-property-value-editor-container\n{\n   display: none;\n}\n\n/* show editor when we're editable in form mode */\n.rsui-editable .rsui-property-value-editor-container\n{\n   display: block;\n}\n\n/**\n * Form Editor\n */\n\n/* no placeholder needed */\n.rsui-edit-mode-form .rsui-property-value-placeholder\n{\n   display: none;\n}\n\n/* don't show viewer when we're editable in form mode */\n.rsui-edit-mode-form.rsui-editable .rsui-property-value-viewer\n{\n   display: none;\n}\n\n\n/**\n * Inline Editor\n */\n\n/* stylize the controls */\n.rsui-inline-cancel, .rsui-inline-confirm\n{\n   border: 0;\n   background-color: transparent;\n   padding: 5px 0px;\n}\n\n/* stylize the confirm button */\n.rsui-inline-confirm\n{\n   float:right;\n   opacity: 0.5;\n   cursor: no-drop;\n}\n\n.rsui-has-changed .rsui-inline-confirm\n{\n   opacity: 1;\n   cursor: pointer;\n}\n\n/* don't show viewer when we're editing in inline mode */\n.rsui-edit-mode-inline.rsui-editing .rsui-property-value-viewer\n{\n   display: none;\n}\n\n /*  Editable State */\n.rsui-edit-mode-inline.rsui-property-container.rsui-editable,\n.rsui-edit-mode-inline.rsui-property-container.rsui-editable .rsui-property-label\n{\n   cursor: pointer;\n}\n\n/* hide the editor when we're not editing */\n.rsui-edit-mode-inline.rsui-editable .rsui-property-value-editor-container\n{\n   /*position: absolute; /* takes the element out of the layout flow */\n   /*opacity: 0;*/\n   display: none;\n}\n\n/* Editing State */\n\n/* go back to normal cursor when we're editing */\n.rsui-edit-mode-inline.rsui-property-container.rsui-editing,\n.rsui-edit-mode-inline.rsui-property-container.rsui-editing .rsui-property-label\n{\n   cursor: default;\n}\n\n/* show the editor when we're editing */\n.rsui-edit-mode-inline.rsui-editing .rsui-property-value-editor-container\n{\n   /*position: static; /* puts the element back into the layout flow */\n   /*opacity: 1;*/\n   display: block;\n}\n\n/* hide the placeholder when we're editing */\n.rsui-edit-mode-inline.rsui-editing .rsui-property-value-placeholder\n{\n   display: none;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SchemaPropertyView = __webpack_require__(9);

	var ObjectSchema = __webpack_require__(171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classnames = __webpack_require__(7);
	var JSONPointer = __webpack_require__(156);

	var PropertySchema = __webpack_require__(157);
	var SchemaPropertyValueViewer = __webpack_require__(165);
	var SchemaPropertyValueEditor = __webpack_require__(166);
	   ...
	   renderInlineEditingControls: function renderInlineEditingControls() {
	      ...
	      if (this.hasChanged()) {
	         confirmControl = React.createElement(
	            "button",
	            { className: "rsui-inline-confirm", tabIndex: "-1", onClick: this.confirmInlineEdit },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var titleCase = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noCase = __webpack_require__(159);
	var upperCase = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NON_WORD_REGEXP = __webpack_require__(161);
	var CAMEL_CASE_REGEXP = __webpack_require__(162);
	var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(163);
